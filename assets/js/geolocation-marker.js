(function () {
	...
	function e(a, c) {
		...
		for (var g in c)if ("prototype" != g)if (Object.defineProperties) {
	...
	function h(a, c, f, g) {
		...
		d.set("position_options", {enableHighAccuracy: !0, maximumAge: 1E3});
		d.a.bindTo("map", d.c);
		d.a.bindTo("map", d.b);
		a && d.setMap(a);
		return d
	...
	var p = {map: !0, position: !0, radius: !0}, n = /^(?:position|accuracy)$/i;
	var q = window;
